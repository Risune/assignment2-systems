...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems import flash_attn
    return flash_attn.FlashAttention2InPytorch
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    # from cs336_systems import flash_attn_triton
    # return flash_attn_triton.FlashAttention2InTriton
    from cs336_systems import flash_attn
    return flash_attn.FlashAttention2InPytorch
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    """
    from cs336_systems import parallel
    return parallel.NaiveDDP(module)
...
def ddp_individual_parameters_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    """
    ddp_model.finish_gradient_synchronization(optimizer)
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    """
    from cs336_systems import parallel
    return parallel.OverLapDDPBucketed(module, bucket_size_mb)
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    from cs336_systems import parallel
    return parallel.ShardingOptimizer(list(params), optimizer_cls, **kwargs)
